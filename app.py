...
def chat():
    ...
    # Handle the user asking for "exercises"
    if 'exercise' in user_message or 'exercises' in user_message:
        return jsonify({
            "response": "Hi! How are you feeling today? I can suggest exercises to help with your mood."
        })
